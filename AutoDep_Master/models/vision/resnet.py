"""
ResNet-50 Training Script for Depression Detection

This script trains a ResNet-50 model for binary classification (depressed vs. non-depressed) 
...
- **Model:** ResNet-50 with a modified fully connected (fc) layer for binary classification.
...
3. Run the script: `python resnet.py`
